...
exports.updateGradeOfAssignment = async (inputGrade) => {
  return new Promise(async (resolve, reject) => {
    try {
      if (
        !inputGrade.grade ||
      ...
      let gradeRes = await Grade.update(
        { grade: inputGrade.grade },
        {
          where: {
            studentId: inputGrade.studentId,
            assignmentId: inputGrade.assignmentId,
          },
        }
      );
      resolve({
